...
const CHATBOT_USER_OBJ = {
  ...
  name: "Hangman Bot",
  avatar:
    "https://st2.depositphotos.com/1832477/45596/v/600/depositphotos_455969364-stock-illustration-wooden-gallows-with-handing-rope.jpg",
};

export default function Hangmanbot() {
  let qBank = [
    "Jenna",
    "Baker",
    "Phoenix",
