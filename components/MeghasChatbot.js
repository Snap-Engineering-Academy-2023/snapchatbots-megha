...
const CHATBOT_USER_OBJ = {
  ...
  avatar:
    "https://st2.depositphotos.com/1915171/5331/v/600/depositphotos_53310845-stock-illustration-question-mark-sign-icon-help.jpg",
};
...
export default function MeghasChatbot() {
    ...
    fetch("https://the-trivia-api.com/v2/questions", requestOptions)
      ...
      .then((result) => {
        ...
        setQuiz({
          ...
          options:
            result[0].incorrectAnswers + ", " + [result[0].correctAnswer],
        });
        console.log("first: ", quiz.quest);
        console.log("first: ", quiz.ans);
        console.log("first: ", quiz.options);
